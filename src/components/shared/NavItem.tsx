...
export const NavItem: React.FC<NavItemProps> = ({ active, icon, label, onClick, desktop }) => (
    <button
      ...
      ${desktop
                ...
                : `flex-col justify-center w-full py-3 relative ${active ? 'text-slate-900 bg-slate-100/80 border-slate-200 shadow-sm' : 'text-slate-400 hover:text-slate-900 hover:bg-slate-100 hover:border-slate-200'}`
            }
    `}
    >
        <div
